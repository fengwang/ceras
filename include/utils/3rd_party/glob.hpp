...
#endif
// adapted from https://github.com/p-ranav/glob
#ifndef GLOB_HPP_INCLUDED_DFSOPIJHSA98U43YAKLFIJSAOSIFJ498UAFLKJASLKASDFJLJFFD8I
#define GLOB_HPP_INCLUDED_DFSOPIJHSA98U43YAKLFIJSAOSIFJ498UAFLKJASLKASDFJLJFFD8I
...
namespace glob
{
    ...
    namespace
    {
        ...
        static inline bool fnmatch_case( const std::filesystem::path& name, const std::string& pattern )
        {
            return std::regex_match( name.string(), compile_pattern( pattern ) );
        }

        static inline std::vector<std::filesystem::path> filter( const std::vector<std::filesystem::path>& names, const std::string& pattern )
        {
        ...
        static inline std::filesystem::path expand_tilde( std::filesystem::path path )
        {
        ...
        static inline std::vector<std::filesystem::path> iter_directory( const std::filesystem::path& dirname, bool dironly )
        {
            std::vector<std::filesystem::path> result;
        ...
        static inline std::vector<std::filesystem::path> rlistdir( const std::filesystem::path& dirname, bool dironly )
        {
            std::vector<std::filesystem::path> result;
        ...
        // directory.
        static inline std::vector<std::filesystem::path> glob2( const std::filesystem::path& dirname, [[maybe_unused]]const std::string& pattern, bool dironly )
        {
            // std::cout << "In glob2\n";
            std::vector<std::filesystem::path> result;
        ...
        static inline std::vector<std::filesystem::path> glob1( const std::filesystem::path& dirname, const std::string& pattern, bool dironly )
        {
            auto names = iter_directory( dirname, dironly );
        ...
        static inline std::vector<std::filesystem::path> glob0( const std::filesystem::path& dirname, const std::filesystem::path& basename, bool /*dironly*/ )
        {
            std::vector<std::filesystem::path> result;
        ...
        static inline std::vector<std::filesystem::path> glob( const std::string& pathname, bool recursive = false, bool dironly = false )
        {
            std::vector<std::filesystem::path> result;
            ...
            std::function<std::vector<std::filesystem::path>( const std::filesystem::path&, const std::filesystem::path&, bool )>
            glob_in_dir;
    ...
    static inline std::vector<std::filesystem::path> glob( const std::string& pathname )
    {
        return glob( pathname, false );
    }

    static inline std::vector<std::filesystem::path> rglob( const std::string& pathname )
    {
...
#endif//GLOB_HPP_INCLUDED_DFSOPIJHSA98U43YAKLFIJSAOSIFJ498UAFLKJASLKASDFJLJFFD8I
