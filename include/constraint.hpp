#ifndef XFIAOXUCSLQJRTHHORBNCVCCJCBECOSSDEUNUYJYPTDGNCRENNGGAQAECDEACURSUVFKFFOJE
#define XFIAOXUCSLQJRTHHORBNCVCCJCBECOSSDEUNUYJYPTDGNCRENNGGAQAECDEACURSUVFKFFOJE
...
namespace ceras
{
    ...
    constexpr inline auto max_norm( Float max_value = 2.0, unsigned long axis = 0 ) noexcept
    {
        return [=]<Variable V>( V const& v ) noexcept
        {
            /*
...
#endif//XFIAOXUCSLQJRTHHORBNCVCCJCBECOSSDEUNUYJYPTDGNCRENNGGAQAECDEACURSUVFKFFOJE
